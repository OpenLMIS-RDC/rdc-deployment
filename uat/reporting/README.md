...
- **Script:** `uat/reporting/db/docker-entrypoint-initdb.d/templates/OlmisCreateAnalyticAggregateSchemaStatements.sql`
...
- **Script:** `uat/reporting/db/docker-entrypoint-initdb.d/templates/OlmisInitDailyAnalyticDataStatements.sql`
...
- **Script:** `uat/reporting/cron/periodic/daily/stock-aggregation`
